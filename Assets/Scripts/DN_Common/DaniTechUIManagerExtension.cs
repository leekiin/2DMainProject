...
public static class DaniTechUIManagerExtension
{
    ...
    public static void OpenRobbyUI(this DaniTechUIManager uiManager)
    {
        var uiBase = uiManager.OpenUI(DaniTechUIRootType.ContentUI, DaniTechUIType.RobbyUI);
        if (uiBase == null)
        {
            Debug.LogWarning($"UI가 생성되지 않았습니다");
            return;
    ...
    public static void CloseRobbyUI(this DaniTechUIManager uiManager)
    {
